...
public class Campus_Delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1602-VCE", "1600-OU","1602-OU" }));
    ...
    private void JB_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_DeleteActionPerformed
        ...
        try
        {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "sreesha", "sreesha");
